...
Este proyecto describe cómo configurar una biblioteca multimedia utilizando PLEX. A continuación, se detallan los pasos para la preparación del entorno, configuración de Docker Compose, implementación y resultados.
